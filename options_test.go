...
func TestOptions(t *testing.T) {
	...
	for _, test := range []struct {
	...
	}{
		{
			...
			want: ptr("cache233: both maximumSize and maximumWeight are set"),
		},
		{
			fn: func(o *Options[string, string]) {
				o.MaximumSize = 100
			...
			want: ptr("cache233: both maximumSize and weigher are set"),
		},
		{
			fn: func(o *Options[string, string]) {
				o.MaximumSize = -1
			},
			want: ptr("cache233: maximumSize should be positive"),
		},
		{
			fn: func(o *Options[string, string]) {
				o.MaximumWeight = 10
			},
			want: ptr("cache233: maximumWeight requires weigher"),
		},
		{
			fn: func(o *Options[string, string]) {
				o.Weigher = func(key string, value string) uint32 {
			...
			want: ptr("cache233: weigher requires maximumWeight"),
		},
		{
			fn: func(o *Options[string, string]) {
				o.InitialCapacity = -1
			},
			want: ptr("cache233: initial capacity should be positive"),
		},
		{
			fn: func(o *Options[string, string]) {
				o.MaximumWeight = 10
