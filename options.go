...
//
//	cache := cache233.Must(&Options[string, string]{
//		MaximumSize:      10_000,
...
func (o *Options[K, V]) validate() error {
	if o.MaximumSize > 0 && o.MaximumWeight > 0 {
		return errors.New("cache233: both maximumSize and maximumWeight are set")
	}
	if o.MaximumSize > 0 && o.Weigher != nil {
		return errors.New("cache233: both maximumSize and weigher are set")
	}

	if o.MaximumWeight > 0 && o.Weigher == nil {
		return errors.New("cache233: maximumWeight requires weigher")
	}
	if o.Weigher != nil && o.MaximumWeight <= 0 {
		return errors.New("cache233: weigher requires maximumWeight")
	}

	if o.MaximumSize < 0 {
		return errors.New("cache233: maximumSize should be positive")
	}
	if o.InitialCapacity < 0 {
		return errors.New("cache233: initial capacity should be positive")
	}
