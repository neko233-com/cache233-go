...
import (
	...
	"github.com/neko233-com/cache233-go/internal/deque/queue"
	"github.com/neko233-com/cache233-go/internal/expiration"
	"github.com/neko233-com/cache233-go/internal/generated/node"
	"github.com/neko233-com/cache233-go/internal/hashmap"
	"github.com/neko233-com/cache233-go/internal/lossy"
	"github.com/neko233-com/cache233-go/internal/xiter"
	"github.com/neko233-com/cache233-go/internal/xmath"
	"github.com/neko233-com/cache233-go/internal/xruntime"
...
func (c *cache[K, V]) doCompute(
	...
	if notValidOp {
		panic(fmt.Sprintf("cache233: invalid ComputeOp: %d", op))
	}
	if recordStats {
		if old != nil && !old.HasExpired(nowNano) {
			c.stats.RecordHits(1)
